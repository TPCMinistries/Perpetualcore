-- =============================================================================
-- RFP Engine — Add California Grants Portal source
-- Project: LDC Brain AI (hgxxxmtfmvguotkowxbu)
-- =============================================================================
-- SAFETY: Constraint-only update. No table drops, no data rewrite.
-- Adds `ca_grants` as an allowed rfp_opportunities.source value so the
-- California Open Data connector can upsert records idempotently.
-- =============================================================================
