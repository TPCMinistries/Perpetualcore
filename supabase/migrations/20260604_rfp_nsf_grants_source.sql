-- =============================================================================
-- RFP Engine — Add NSF grants source
-- Project: LDC Brain AI (hgxxxmtfmvguotkowxbu)
-- =============================================================================
-- SAFETY: Constraint-only update. No table drops, no data rewrite.
-- Adds `nsf_grants` as an allowed rfp_opportunities.source value so the
-- NSF-focused Grants.gov connector can upsert records idempotently.
-- =============================================================================
