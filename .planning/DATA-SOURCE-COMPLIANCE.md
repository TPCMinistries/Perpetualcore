...
| 15 | `nj_grants` | New Jersey grants and procurement | **planned** | html_scrape | https://www.nj.gov | Planned for Phase 16. NJ state procurement data is publicly published. Verify nj.gov and njopa.gov scraping policy before go-live. | **PLANNED — verify before live** |
| 16 | `ct_grants` | Connecticut grants and procurement | **planned** | html_scrape | https://portal.ct.gov | Planned. Connecticut state procurement and grants data is publicly published. Verify ct.gov scraping policy before go-live. | **PLANNED — verify before live** |
| 17 | `pa_grants` | Pennsylvania grants and procurement | **planned** | html_scrape | https://www.pa.gov | Planned. Pennsylvania state procurement data is publicly published. Verify pa.gov scraping policy before go-live. | **PLANNED — verify before live** |
| 18 | `nih_guide_notices` | NIH Guide notices | **planned** | html_scrape | https://grants.nih.gov/funding/searchguide/index.html | Planned. NIH Guide notices are public-domain government publications. | **PLANNED — compliant by public domain basis** |
| 19 | `irs_990_foundations` | IRS 990 foundation intelligence | **planned** | api | https://www.irs.gov/charities-non-profits / https://projects.propublica.org/nonprofits/api | Planned for Phase 16. See "ProPublica / IRS 990" section below. IRS 990 filings are public-domain government records. ProPublica Nonprofit Explorer API provides access to this data — ToS review required before Phase 16 integration. | **PLANNED — action required before Phase 16** |
...
| 21 | `corporate_foundations` | Corporate foundation programs | **planned** | curated | N/A — curated list | Planned. Will use publicly available corporate giving program information. No licensed or restricted data source identified. Curated list approach avoids bulk proprietary data. | **PLANNED — verify each source before live** |
| 22 | `bank_cra` | Bank CRA and community grants | **planned** | curated | N/A — curated list | Planned. Bank CRA disclosures are federally mandated public records under the Community Reinvestment Act. No proprietary data involved. | **PLANNED — compliant by CRA public disclosure basis** |
...
- For planned sources (rows 15–19, 21–22): compliance is noted as provisional pending final verification at go-live.
