...
const PRODUCTS = [
  ...
  { index: "03", name: "Sage", status: "BUILD", statusColor: "invite" as const, tagline: "The coach and chief of staff who never forgets you.", href: "/products/sage", external: false },
  { index: "04", name: "Vellum", status: "BUILD", statusColor: "invite" as const, tagline: "Institutional memory — calls, docs, voice notes, channels.", href: "/products/vellum", external: false },
  { index: "05", name: "Platform", status: "LIVE", statusColor: "live" as const, tagline: "AI OS for individuals and small teams. 11 models, persistent memory.", href: "/products/platform", external: false },
  { index: "06", name: "RFP Engine", status: "LIVE", statusColor: "live" as const, tagline: "Find the right RFP. Draft it in your voice. Ship it clean.", href: "/products/rfp-engine", external: false },
