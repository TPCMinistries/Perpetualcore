...
const SOURCE_OPTIONS: Array<{ key: string; label: string }> = [
  ...
  { key: "nih_grants", label: "NIH Grants" },
  { key: "nih_guide_notices", label: "NIH Guide" },
  { key: "nsf_grants", label: "NSF Grants" },
  ...
  { key: "pa_grants", label: "PA Grants" },
  { key: "corporate_foundations", label: "Corporate" },
  { key: "bank_cra", label: "Bank CRA" },
