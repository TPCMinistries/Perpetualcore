  ...
  return (
    <div className="relative">
      <div className="mx-auto max-w-3xl px-6 py-12">
        ...
        <h1
          className="mt-3 text-3xl text-zinc-900 italic"
        ...
        {sp.status === "success" ? (
          <div className="mt-6 rounded-md border border-emerald-200 bg-emerald-50 p-4 text-[13px] text-emerald-700">
        ...
        {sp.status === "cancel" ? (
          <div className="mt-6 rounded-md border border-zinc-200 bg-zinc-50 p-4 text-[13px] text-zinc-600">
        ...
        <section className="mt-10 rounded-lg border border-zinc-200 bg-white p-6 shadow-sm">
          ...
          <dl className="mt-6 grid grid-cols-2 gap-x-6 gap-y-4 text-[13px]">
            ...
            <div>
              ...
              <dd className="mt-1 font-mono text-[12px] text-zinc-500">
          ...
          {canBill ? (
            ...
            <p className="mt-6 border-t border-zinc-200 pt-4 text-[12px] text-zinc-500">
        ...
        <p className="mt-10 text-[12px] leading-relaxed text-zinc-500">
          ...
          <span className="text-zinc-700">14-day free trial</span>. Cancel any
