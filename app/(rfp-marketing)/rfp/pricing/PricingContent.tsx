...
export function PricingContent() {
  return (
    <main className="relative">
      ...
      {/* PRICING GRID */}
      <section className="relative border-b border-white/5 bg-zinc-950" aria-labelledby="rfp-pricing-grid-heading">
        <div className="container mx-auto px-4 py-20">
          <h2 id="rfp-pricing-grid-heading" className="sr-only">
            Pricing plans
          </h2>
            ...
            >
              <Card className="h-full border-white/5 bg-gradient-to-br from-white/[0.04] to-transparent">
                <CardContent className="flex h-full flex-col justify-between p-6">
                  ...
                  <p className="mt-5 font-mono text-[10px] uppercase tracking-[0.16em] text-zinc-400">
