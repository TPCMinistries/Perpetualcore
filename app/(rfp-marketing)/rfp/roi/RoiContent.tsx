  ...
  return (
    <div>
      <label
        ...
        className="block text-[13px] font-medium text-zinc-100"
      >
        {label}
      </label>
      {detail ? (
        <div id={detailId} className="mt-1 text-[12px] text-zinc-400">
          {detail}
        </div>
      ) : null}
      <div className="mt-3 flex items-center gap-3">
        <input
          ...
          className="h-1.5 flex-1 cursor-pointer appearance-none rounded-full bg-zinc-800 accent-emerald-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950"
        />
        <div className="flex items-baseline gap-1.5 rounded-md border border-white/5 bg-zinc-950/60 px-3 py-1.5 focus-within:border-emerald-400/60 focus-within:ring-2 focus-within:ring-emerald-400/40">
          <input
            id={numberInputId}
            type="number"
            min={min}
          ...
          />
          {suffix ? (
            <span aria-hidden="true" className="font-mono text-[10px] uppercase tracking-[0.18em] text-zinc-400">
              {suffix}
            </span>
          ) : null}
        </div>
