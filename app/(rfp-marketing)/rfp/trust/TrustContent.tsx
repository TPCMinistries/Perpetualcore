              ...
              return (
                ...
                >
                  <div className="mb-6 flex items-center justify-between">
                    ...
                    <span className="font-mono text-[10px] uppercase tracking-[0.2em] text-zinc-400" aria-hidden="true">
          ...
          >
            <div className="overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent p-6 font-mono text-[11.5px] leading-[1.8] text-zinc-400 md:p-8">
              ...
              <div className="grid gap-1 md:grid-cols-[auto_1fr] md:gap-x-6">
                ...
                <span>
                  user request <span className="text-zinc-400" aria-hidden="true">→</span> JWT with{" "}
                  <span className="text-zinc-200">org_id</span> claim
                </span>
                <span className="text-emerald-300">[2]</span>
                <span>
                  Postgres session <span className="text-zinc-400" aria-hidden="true">→</span>{" "}
                  <span className="text-zinc-200">SET app.current_org = org_id</span>
                </span>
                <span className="text-emerald-300">[3]</span>
                <span>
                  RLS policy <span className="text-zinc-400" aria-hidden="true">→</span> rows where{" "}
                  <span className="text-zinc-200">organization_id = current_org</span>
                </span>
                <span className="text-emerald-300">[4]</span>
                <span>
                  vault decrypt <span className="text-zinc-400" aria-hidden="true">→</span> per-tenant DEK
                </span>
                <span className="text-emerald-300">[5]</span>
                <span>
                  inference call <span className="text-zinc-400" aria-hidden="true">→</span> zero-retention header,
                  scoped context only
                </span>
                <span className="text-emerald-300">[6]</span>
                <span>
                  log line <span className="text-zinc-400" aria-hidden="true">→</span> append-only audit_events
                </span>
              </div>
            </div>
          </motion.div>
        ...
        <div className="container mx-auto px-4 py-28">
          ...
          <div className="mx-auto max-w-5xl">
            <div className="hidden overflow-hidden rounded-2xl border border-white/10 md:block">
              <div className="grid grid-cols-12 gap-4 border-b border-white/10 bg-white/[0.02] px-6 py-4 font-mono text-[10px] uppercase tracking-[0.18em] text-zinc-400">
              ...
              {subprocessors.map((s, i) => (
                ...
                >
                  ...
                  <div className="col-span-2 text-right font-mono text-[11px] uppercase tracking-[0.16em] text-zinc-400">
                    {s.region}
                  </div>
                </motion.div>
              ))}
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container relative mx-auto px-4 py-28 text-center">
          ...
          >
            ...
            <div className="mx-auto mt-10 flex max-w-md items-center justify-center gap-3 font-mono text-[11px] uppercase tracking-[0.18em] text-zinc-400">
