              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b text-left">
                    ...
                    <th className="pb-2 font-medium text-gray-600">Actor</th>
                    <th className="pb-2 font-medium text-gray-600">Event</th>
                    <th className="pb-2 font-medium text-gray-600">Resource</th>
