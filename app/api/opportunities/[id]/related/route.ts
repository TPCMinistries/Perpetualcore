...
// GET /api/opportunities/[id]/related - Get related items for an opportunity
  ...
  try {
    ...
    if (error) {
      ...
      [...(outgoing || []), ...(incoming || [])].forEach(r => {
        const type = r.source_type === "opportunity" ? r.target_type : r.source_type;
        const relId = r.source_type === "opportunity" ? r.target_id : r.source_id;
...
// POST /api/opportunities/[id]/related - Link a related item
...
// DELETE /api/opportunities/[id]/related - Remove a relationship
