    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        <section className="relative overflow-hidden border-b border-border bg-[#f5f3ff]">
          <div className="absolute -right-28 -top-32 h-[460px] w-[460px] rounded-full border-[76px] border-primary/80" aria-hidden="true" />
          <div className="container relative mx-auto grid gap-14 px-6 py-20 sm:px-8 sm:py-28 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
            <div>
              <div className="flex items-center gap-3"><span aria-hidden className="block h-1.5 w-1.5 bg-primary" /><p className="eyebrow !text-primary">Perpetual Core · Development Intelligence</p></div>
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                <Button asChild size="lg" className="min-h-12 bg-primary px-7 text-base hover:bg-primary">
                  <Link href="/dashboard/development/agent">Open the agent studio <ArrowRight className="ml-2 h-4 w-4" /></Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="min-h-12 border-primary/20 bg-white px-7 text-base text-primary hover:bg-primary/10">
            ...
            <div className="rounded-2xl border border-primary/20 bg-white p-5 sm:p-7">
              ...
              <blockquote className="mt-3 rounded-xl border-l-4 border-primary/40 bg-primary/10 px-4 py-3 text-sm italic leading-6 text-primary">“I’ll own the revised plan and bring it back to the team.”</blockquote>
